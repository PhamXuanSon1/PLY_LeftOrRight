...
public enum PoolType {Heart, CorrectEffect, BreakHeart }
...
public class Ply_Pool : Ply_Singleton<Ply_Pool>
{
    ...
    public T Spawn<T>(PoolType poolType, [Bridge.Ref] Vector3 pos, [Bridge.Ref] Quaternion rot) where T : Ply_GameUnit
    {
